    ...
    <div class="flex flex-col max-w-screen-xl px-8 mx-auto lg:items-center lg:justify-between lg:flex-row py-4">
      <div class="flex flex-col lg:flex-row items-center space-x-4 xl:space-x-8">
        <div class="w-full flex flex-row items-center justify-between py-6">
          <div>
            <a
              ...
              aria-current="page"
              href="/"
              class="router-link-active router-link-exact-active text-center xl:text-left my-3 xl:my-0 xl:py-5 block col-span-4 xl:col-span-8 text-primary-700"
            >
        ...
        >
          ...
          <li class="relative group">
            ...
            <transition name="transform-fade-down">
              ...
              >
                <div
                  id="layanan-drop"
                  class="xl:absolute top-full xl:w-96 text-left left-0 xl:bg-white p-3.5 rounded-xl shadow-sm"
                >
                  <span
                    class="w-4 hidden xl:inline h-4 absolute border-x-8 border-x-transparent border-b-8 border-b-white top-0 left-7 -translate-y-full"
                  />
                  <div
                    class="flex gap-4 place-items-center relative border border-transparent hover:border-neutral-300 px-3 py-2 hover:bg-primary-50 rounded-2xl"
                  >
                    <a href="https://kiriminaja.com/toko-online" class="top-0 left-0 w-full h-full absolute" />
                    <div>
                      <div
                        class="aspect-square text-primary-400 p-2 rounded-full bg-primary-50"
                      >
                        <svg
                        ...
                        >
                          ...
                          />
                          <path d="M14 15m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0" class="text-orange-300" />
                          <path d="M6 21a2 2 0 0 0 2 -2v-5.82a5 5 0 0 0 -.528 -2.236l-1.472 -2.944" />
                          <path d="M11 7h2" class="text-orange-300" />
                        </svg>
                      </div>
                    </div>
                    <div>
                  ...
                  <div
                    class="flex gap-4 place-items-center relative border border-transparent hover:border-neutral-300 px-3 py-2 hover:bg-primary-50 rounded-2xl"
                  >
                    <a href="https://kiriminaja.com/praktisin" class="top-0 left-0 w-full h-full absolute" />
                    <div>
                      <div
                        class="aspect-square text-primary-400 p-2 rounded-full bg-primary-50"
                      >
                        ...
                        >
                          ...
                          <path d="M5 11h1v2h-1z" class="text-orange-300" />
                          <path d="M10 11l0 2" class="text-orange-300" />
                          <path d="M14 11h1v2h-1z" class="text-orange-300" />
                          <path d="M19 11l0 2" class="text-orange-300" />
                        </svg>
                      </div>
                    </div>
                    <div>
                  ...
                  <div
                    class="flex gap-4 place-items-center relative border border-transparent hover:border-neutral-300 px-3 py-2 hover:bg-primary-50 rounded-2xl"
                  >
                    <a href="/integration" class="top-0 left-0 w-full h-full absolute" />
                    <div>
                      <div
                        class="aspect-square text-primary-400 p-2 rounded-full bg-primary-50"
                      >
          ...
          <NavLink name="Cek Ongkir" url="#" class="whitespace-nowrap" />
          <NavLink name="Lacak" url="#" />
        </ul>
      </div>
      <div :class="[open ? 'flex' : 'hidden lg:flex']" class="space-x-3">
        <BaseButton class="px-8 xl:px-10 py-3 mt-2 bg-inherit border border-primary-700 text-primary-700">
          Masuk
        </BaseButton>
        <BaseButton class="px-8 xl:px-10 py-3 mt-2 bg-gradient-to-r from-primary-700 to-primary-800 text-white">
          Daftar Gratis
        </BaseButton>
      </div>
    </div>
